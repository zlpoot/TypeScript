...
The `undefined` literal denotes the value given to all uninitialized variables and is the one and only value of the Undefined type.
The `undefined` keyword references the Undefined type.
